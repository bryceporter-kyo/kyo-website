    ...
    <div>
      ...
      <section className="container mx-auto">
        <div className="max-w-4xl mx-auto space-y-8">
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline text-2xl">Accessibility Policy Overview</CardTitle>
                </CardHeader>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline text-xl">Description of Policy</CardTitle>
                </CardHeader>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline text-xl">Accessible Customer Service</CardTitle>
                </CardHeader>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline text-xl">Information and Communications</CardTitle>
                </CardHeader>
                <CardContent className="text-muted-foreground space-y-4">
                    <p>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline text-xl">Employment and Volunteers</CardTitle>
                </CardHeader>
                <CardContent className="text-muted-foreground space-y-4">
                    <p>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline text-xl">Built Environment and Events</CardTitle>
                </CardHeader>
                <CardContent className="text-muted-foreground">
                    <p>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline text-xl">Procurement and Third Parties</CardTitle>
                </CardHeader>
                <CardContent className="text-muted-foreground">
                    <p>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline text-xl">Training</CardTitle>
                </CardHeader>
                <CardContent className="text-muted-foreground space-y-4">
                    <p>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline text-xl">Feedback and Complaints</CardTitle>
                </CardHeader>
                <CardContent className="text-muted-foreground">
                    <p>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline text-xl">Multi-Year Accessibility Plan</CardTitle>
                </CardHeader>
                <CardContent className="text-muted-foreground space-y-4">
                    <p>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline text-xl">General Terms</CardTitle>
                </CardHeader>
                <CardContent className="text-muted-foreground space-y-4">
