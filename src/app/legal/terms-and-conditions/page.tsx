        ...
        <Card className="max-w-4xl mx-auto">
          ...
          <CardContent className="space-y-6 text-muted-foreground">
            <div className="space-y-4">
              <h3 className="font-bold text-xl font-headline text-foreground">Introduction</h3>
            ...
            <div className="space-y-4">
              <h3 className="font-bold text-xl font-headline text-foreground">Purpose of the Terms and Conditions</h3>
            ...
            <div className="space-y-4">
              <h3 className="font-bold text-xl font-headline text-foreground">Definitions</h3>
            ...
            <div className="space-y-4">
              <h3 className="font-bold text-xl font-headline text-foreground">Applicability and Scope</h3>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">Governing Law and Applicable Legislation Policy</h3>
            ...
            <div className="space-y-4">
              <h3 className="font-bold text-xl font-headline text-foreground">Financial Policies</h3>
            ...
            <div className="space-y-4">
              <h3 className="font-bold text-xl font-headline text-foreground">Youth-Teacher-Volunteer Interactions Policy</h3>
            ...
            <div className="space-y-4">
              <h3 className="font-bold text-xl font-headline text-foreground">Health and Safety Policies</h3>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">Privacy and Data Protection Policy</h3>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">Inclusivity and Non-Discrimination Policy</h3>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">Intellectual Property Policy</h3>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">Code of Conduct</h3>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">Liability</h3>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">Anti-Bullying and Harassment Policy</h3>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">Surveys and Survey Collection Policy</h3>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">Termination and Withdrawal Policy</h3>
