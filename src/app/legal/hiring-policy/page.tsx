    ...
    <div>
      ...
      <section className="container mx-auto">
        <Card className="max-w-4xl mx-auto">
          <CardHeader>
            <CardTitle className="font-headline text-2xl">Hiring & EEO Policy</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6 text-muted-foreground">
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">2. Equal Employment Opportunity</h3>
                <p>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">3. Recruitment Process</h3>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">4. Offer and Onboarding</h3>
                <div className="space-y-2 pl-4">
             ...
             <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">5. Compliance and Review</h3>
                <div className="space-y-2 pl-4">
