    ...
    <div>
      ...
      <section className="container mx-auto">
        <Card className="max-w-4xl mx-auto">
          <CardHeader>
            <CardTitle className="font-headline text-2xl">Protection of Children and Vulnerable Persons Policy</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6 text-muted-foreground">
            
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">1. Introduction</h3>
                <p>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">2. Scope and Definitions</h3>
                <h4 className="font-bold text-lg font-headline text-foreground pt-2">2.1 Scope</h4>
                <p>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">3. Duty of Care</h3>
                <p>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">4. Screening and Compliance</h3>
                 <h4 className="font-bold text-lg font-headline text-foreground pt-2">4.1 Police Vulnerable Sector Screening Check</h4>
                <p>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">5. Standards of Conduct</h3>
                <h4 className="font-bold text-lg font-headline text-foreground pt-2">5.1 Good Practices</h4>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">6. Mandatory Reporting of Abuse</h3>
                <h4 className="font-bold text-lg font-headline text-foreground pt-2">6.1 Legal Obligation</h4>
                <p>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">7. Code of Conduct</h3>
                <p>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">8. Oversight and Accountability</h3>
                <p>
            ...
            <div className="space-y-4">
                <h3 className="font-bold text-xl font-headline text-foreground">9. Commitment Statement</h3>
                <p>
